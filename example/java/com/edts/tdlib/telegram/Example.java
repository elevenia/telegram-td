...
//
package com.edts.tdlib.telegram;

import com.edts.tdlib.Client;
import com.edts.tdlib.TdApi;
import com.edts.tdlib.TdApi.InputFile;
...
public final class Example {
    ...
    private static void sendMessage(long chatId, String message) {
        ...
        TdApi.InputFile local = new TdApi.InputFileLocal("/Users/jonathankur/Downloads/proposal_dc.pdf");
        
        TdApi.InputMessageContent content2 = new TdApi.InputMessagePhoto(local, null, null, 100, 100, new TdApi.FormattedText(message, null), 60);
        
        TdApi.InputMessageContent content3 = new TdApi.InputMessageDocument(local, null, new TdApi.FormattedText(message, null));
        client.send(new TdApi.SendMessage(chatId, 0, null, replyMarkup, content3), defaultHandler);
        
        //client.send(new TdApi.CreatePrivateChat(264459274, true), defaultHandler);
        //client.send(new TdApi.SendMessage(chatId, 0, null, replyMarkup, content2), defaultHandler);
        
        
        //client.send(new TdApi.SearchContacts("ivan jo",99), defaultHandler);
        //TdApi.MessageContact
        //client.send(new TdApi.GetUser(264459274), defaultHandler);
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        if (Client.execute(new TdApi.SetLogStream(new TdApi.LogStreamFile("/Users/jonathankur/Documents/code/tdlib.log", 1 << 27))) instanceof TdApi.Error) {
